...
public:
    ...
    static size_t hash(const Data<RelationBinding<T, ObjectTag>>& builder) noexcept { return ygg::BlockArraySet<ygg::uint_t, Coder<ygg::uint_t>>::hash(builder.objects); }
    ...
    ConstViewType at_local(Index<RelationBinding<T, ObjectTag>> index) const noexcept
    {
