...
#ifndef YGGDRASIL_FORMALISM_BINDING_INDEX_HPP_
#define YGGDRASIL_FORMALISM_BINDING_INDEX_HPP_
...
template <typename Relation, typename ObjectTag,
          std::ranges::forward_range BindingRange>
...
template <typename Relation, typename ObjectTag,
          std::ranges::random_access_range BindingRange>
  requires std::same_as<
      std::remove_cvref_t<std::ranges::range_reference_t<BindingRange>>,
      Index<ygg::formalism::Row>>
