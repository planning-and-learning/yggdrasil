...
// Header-only copy of the reference implementation. Block reads assume
// little-endian, which is asserted below so a big-endian port fails loudly
// instead of silently changing hash values.

#ifndef YGG_SEMANTICS_MURMURHASH3_HPP_
...
#endif  // YGG_SEMANTICS_MURMURHASH3_HPP_
