...
#ifndef YGG_SERIALIZATION_CISTA_EQUAL_TO_HPP_
#define YGG_SERIALIZATION_CISTA_EQUAL_TO_HPP_
...
struct EqualTo<View<::cista::array<T, N>, C>>
{
...
struct EqualTo<::cista::pair<T1, T2>>
{
...
struct EqualTo<View<::cista::pair<T1, T2>, C>>
{
