...
TEST(YggdrasilTests, CommonBitPackedArraySetOutOfRange) {
  auto set =
      ygg::BitPackedArraySet<ygg::uint_t,
                             ygg::bit::ForwardingBlockCoder<ygg::uint_t>, 1>(2,
                                                                             2);
...
TEST(YggdrasilTests, CommonBitPackedArraySetDeduplicatesZeroLengthArrays) {
  auto set =
      ygg::BitPackedArraySet<uint8_t, ygg::bit::ForwardingBlockCoder<uint8_t>,
                             1>(0, 1);
