...
TEST(YggdrasilTests, CommonHashRangeMatchesContainerHash) {
  ...
  EXPECT_EQ(ygg::hash_range(std::span<const int>(values)),
            ygg::Hash<std::span<const int>>{}(std::span<const int>(values)));
}
...
TEST(YggdrasilTests, CommonHashAdaptersHashVariantAlternativeIndex) {
  ...
  const auto first_alternative =
      DuplicateTypeVariant(std::in_place_index<0>, 9);
  const auto second_alternative =
      DuplicateTypeVariant(std::in_place_index<1>, 9);
  EXPECT_NE(ygg::Hash<DuplicateTypeVariant>{}(first_alternative),
            ygg::Hash<DuplicateTypeVariant>{}(second_alternative));
}
...
TEST(YggdrasilTests, CommonHashAdaptersMixOptionalEngagementState) {
  ...
  EXPECT_EQ(ygg::Hash<std::optional<int>>{}(zero),
            ygg::Hash<std::optional<int>>{}(another_zero));
  EXPECT_NE(ygg::Hash<std::optional<int>>{}(empty),
            ygg::Hash<std::optional<int>>{}(zero));
}
...
TEST(YggdrasilTests, CommonReferenceWrapperHashAdaptersHashReferencedValues) {
  ...
  EXPECT_EQ(ygg::Hash<std::reference_wrapper<int>>{}(lhs),
            ygg::Hash<std::reference_wrapper<int>>{}(rhs));
  EXPECT_NE(ygg::Hash<std::reference_wrapper<int>>{}(lhs),
            ygg::Hash<std::reference_wrapper<int>>{}(different));
}
...
TEST(YggdrasilTests, CommonCistaHashAdaptersHashOffsetVector) {
  ...
  EXPECT_EQ(ygg::hash_range(values),
            ygg::Hash<::cista::offset::vector<int>>{}(values));
}

TEST(YggdrasilTests,
     CommonCistaHashAdaptersHashOffsetStringOptionalAndVariant) {
  auto lhs_string = ::cista::offset::string{};
  auto rhs_string = ::cista::offset::string{};
  lhs_string = "alpha";
  rhs_string = "alpha";
  EXPECT_EQ(ygg::Hash<::cista::offset::string>{}(lhs_string),
            ygg::Hash<::cista::offset::string>{}(rhs_string));
  ...
  EXPECT_EQ(ygg::Hash<::cista::optional<int>>{}(lhs_optional),
            ygg::Hash<::cista::optional<int>>{}(rhs_optional));
  EXPECT_NE(ygg::Hash<::cista::optional<int>>{}(lhs_optional),
            ygg::Hash<::cista::optional<int>>{}(empty_optional));
  EXPECT_NE(ygg::Hash<::cista::optional<int>>{}(empty_optional),
            ygg::Hash<::cista::optional<int>>{}(zero_optional));
  ...
  EXPECT_EQ(ygg::Hash<Variant>{}(lhs_variant),
            ygg::Hash<Variant>{}(rhs_variant));
  EXPECT_NE(ygg::Hash<Variant>{}(lhs_variant),
            ygg::Hash<Variant>{}(different_type_variant));
  ...
  EXPECT_NE(ygg::Hash<DuplicateTypeVariant>{}(duplicate_first),
            ygg::Hash<DuplicateTypeVariant>{}(duplicate_second));
}
...
TEST(YggdrasilTests, CommonObserverPtrHashAdaptersHashPointee) {
  ...
  EXPECT_EQ(ygg::Hash<int>{}(value),
            ygg::Hash<ygg::ObserverPtr<const int>>{}(ptr));
}
...
TEST(YggdrasilTests, CommonDynamicBitsetHashAdaptersHashBoostDynamicBitsets) {
  ...
  EXPECT_EQ(ygg::Hash<boost::dynamic_bitset<>>{}(lhs),
            ygg::Hash<boost::dynamic_bitset<>>{}(rhs));

  rhs.set(2);

  EXPECT_NE(ygg::Hash<boost::dynamic_bitset<>>{}(lhs),
            ygg::Hash<boost::dynamic_bitset<>>{}(rhs));
}
...
TEST(YggdrasilTests, CommonDynamicBitsetHashAdaptersHashBitsetSpans) {
  ...
  const auto different =
      ygg::BitsetSpan<const std::uint64_t>(different_blocks.data(), 4);

  EXPECT_EQ(ygg::Hash<ygg::BitsetSpan<const std::uint64_t>>{}(lhs),
            ygg::Hash<ygg::BitsetSpan<const std::uint64_t>>{}(rhs));
  EXPECT_NE(ygg::Hash<ygg::BitsetSpan<const std::uint64_t>>{}(lhs),
            ygg::Hash<ygg::BitsetSpan<const std::uint64_t>>{}(different));
}
...
TEST(YggdrasilTests, CommonCistaHashAdaptersHashViews) {
  ...
  EXPECT_EQ(ygg::Hash<VectorView>{}(VectorView(lhs_vector, context)),
            ygg::Hash<VectorView>{}(VectorView(rhs_vector, context)));
  ...
  EXPECT_EQ(ygg::Hash<OptionalView>{}(OptionalView(lhs_optional, context)),
            ygg::Hash<OptionalView>{}(OptionalView(rhs_optional, context)));
  EXPECT_NE(ygg::Hash<OptionalView>{}(OptionalView(empty_optional, context)),
            ygg::Hash<OptionalView>{}(OptionalView(zero_optional, context)));
  ...
  EXPECT_EQ(ygg::Hash<VariantView>{}(VariantView(lhs_variant, context)),
            ygg::Hash<VariantView>{}(VariantView(rhs_variant, context)));
  EXPECT_NE(
      ygg::Hash<VariantView>{}(VariantView(lhs_variant, context)),
      ygg::Hash<VariantView>{}(VariantView(different_type_variant, context)));
  EXPECT_EQ(ygg::Hash<VariantView>{}(VariantView(Variant{}, context)),
            ygg::Hash<VariantView>{}(VariantView(Variant{}, context)));
  EXPECT_NE(ygg::Hash<VariantView>{}(VariantView(Variant{}, context)),
            ygg::Hash<VariantView>{}(VariantView(lhs_variant, context)));
}
...
TEST(YggdrasilTests, CommonBlockArrayHashAdaptersHashViews) {
  ...
  using BlockView =
      ygg::BasicBlockArrayView<uint8_t,
                               ygg::bit::ForwardingBlockCoder<uint8_t>>;
  const auto lhs = BlockView(lhs_storage.data(), lhs_storage.size());
  const auto rhs = BlockView(rhs_storage.data(), rhs_storage.size());
  const auto different =
      BlockView(different_storage.data(), different_storage.size());
  ...
  EXPECT_EQ(ygg::Hash<WrappedView>{}(WrappedView(lhs, context)),
            ygg::Hash<WrappedView>{}(WrappedView(rhs, context)));
}
...
TEST(YggdrasilTests, CommonRawAndSegmentedVectorHashAdaptersHashValues) {
  ...
  EXPECT_EQ((ygg::Hash<ygg::RawVectorView<uint8_t, int>>{}(pool[lhs_index])),
            (ygg::Hash<ygg::RawVectorView<uint8_t, int>>{}(pool[rhs_index])));
  EXPECT_NE(
      (ygg::Hash<ygg::RawVectorView<uint8_t, int>>{}(pool[lhs_index])),
      (ygg::Hash<ygg::RawVectorView<uint8_t, int>>{}(pool[different_index])));
  ...
  EXPECT_EQ((ygg::Hash<ygg::SegmentedVector<int, 2>>{}(lhs)),
            (ygg::Hash<ygg::SegmentedVector<int, 2>>{}(rhs)));
  EXPECT_NE((ygg::Hash<ygg::SegmentedVector<int, 2>>{}(lhs)),
            (ygg::Hash<ygg::SegmentedVector<int, 2>>{}(different)));
}
