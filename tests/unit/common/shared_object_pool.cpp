...
TEST(YggdrasilTests, CommonSharedObjectPoolRecoversFromFailedInitialization) {
  expect_shared_pool_recovers_from_failed_initialization<false>();
}

TEST(YggdrasilTests,
     CommonThreadSafeSharedObjectPoolRecoversFromFailedInitialization) {
  expect_shared_pool_recovers_from_failed_initialization<true>();
}
